...
if __name__ == "__main__":
    ...
    # team2 = "Oregon"
    CSVFILE = 'MM_24_Update_2.csv'


    fields = ['team_name_1', 'team_name_2', 'survive', 'defeat']
    team_list = create_team_list(CSVFILE)
    prediction_list = []
    for team1 in team_list:
        for team2 in team_list:
            if team1 != team2:
                team1_values = logreg_predict(team1, team2, CSVFILE)
                prediction_list.append([team1, team2, team1_values[0], team1_values[1]])

    #Write List to CSV File:
    csv_file = 'MM_24_Predictions.csv'
    ...
    # Write all of the rows of data to the CSV file
        csv_writer.writerows(prediction_list)
